...
{
    const std::string value{ static_cast<char>(varint_eight_bytes), 0x03,
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 'a', 'b', 'c' };
    std::istringstream stream{ value };
    read::bytes::istream reader(stream);
    BOOST_REQUIRE_EQUAL(reader.read_string(), "abc");
}
...
BOOST_AUTO_TEST_CASE(byte_reader__read_line__no_terminator__invalidates)
{
...
BOOST_AUTO_TEST_CASE(byte_reader__read_line__custom_terminator__expected)
{
...
BOOST_AUTO_TEST_CASE(byte_reader__read_line__terminator_only__expected_position_empty)
{
...
BOOST_AUTO_TEST_CASE(byte_reader__read_line__multiple_terminators__expected_positions_empty)
{
    const std::string value{ "\r\n\r\n" };
    std::istringstream stream{ value };
    read::bytes::istream reader(stream);
...
BOOST_AUTO_TEST_CASE(byte_reader__read_line__text_before_terminator__returns_text)
{
    const std::string value{ "hello\r\n" };
    std::istringstream stream{ value };
    read::bytes::istream reader(stream);
...
BOOST_AUTO_TEST_CASE(byte_reader__read_line__partial_match__handles_correctly)
{
...
BOOST_AUTO_TEST_CASE(byte_reader__read_line__multiple_lines__returns_sequential)
{
